...
const specifiedBy = _i1.DirectiveDefinitionNode(
    ...
    repeatable: false);
const Map = _i1.ObjectTypeDefinitionNode(
...
const Shop = _i1.ObjectTypeDefinitionNode(
    ...
    fields: [
      ...
      _i1.FieldDefinitionNode(
          ...
          args: [],
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'Map'), isNonNull: false)),
      _i1.FieldDefinitionNode(
          name: _i1.NameNode(value: 'url'),
          directives: [],
          args: [],
...
const document = _i1.DocumentNode(definitions: [specifiedBy, Map, Query, Shop]);
